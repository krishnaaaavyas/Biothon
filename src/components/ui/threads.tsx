...
export function Threads({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      const {
        color: currentPropColor,
        amplitude: currentPropAmplitude,
        distance: currentPropDistance,
        enableMouseInteraction: currentPropMouse,
      } = propsRef.current;

      program.uniforms.uColor.value.set(...currentPropColor);
      program.uniforms.uAmplitude.value = currentPropAmplitude;
      program.uniforms.uDistance.value = currentPropDistance;
